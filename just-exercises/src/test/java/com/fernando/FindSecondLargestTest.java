...
class FindSecondLargestTest {
    ...
    void shouldFindSecondValue99() {
        ...
        Integer maybeSecond = target.findSecondLargest(101, 99, 34, 2, 17);
    ...
    void shouldFindSecondValue313() {
        ...
        Integer maybeSecond = target.findSecondLargest(1000, 313, 1000, 313, 1000, 313, 24);
    ...
    void shouldFindSecondValue777() {
        ...
        Integer maybeSecond = target.findSecondLargest(2500, 2500, 777, 777, 50, 777);
    ...
    void shouldFindSecondValueWith2Equal() {
        ...
        Integer maybeSecond = target.findSecondLargest(17, 17);
    ...
    void shouldFindSecondValueWithOne() {
        ...
        Integer maybeSecond = target.findSecondLargest(17);
    ...
    void shouldFindSecondValueWithEmpty() {
        ...
        Integer maybeSecond = target.findSecondLargest();
